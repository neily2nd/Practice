...
def add_number_strings(first_string, second_string):
    number = int(first_string) + int(second_string)
    return number
...
#   Returns: 50
# Note: return value should be a number, not a string
def multiply_number_strings(first_string, second_string):
    number = int(first_string) * int(second_string)
    return number
...
#   Call:    both_odd(6, 10)
#   Returns: False
def both_odd(first_number, second_number):
...
#   Call:    both_even(5, 11)
#   Returns: False
def both_even(first_number, second_number):
    if first_number % 2 == 0 and second_number % 2 == 0:
        return True
    else:
        return False
...
#   Call:    one_odd(4, 8)
#   Returns: False
def one_odd(first_number, second_number):
...
#   Call:    one_even(5, 9)
#   Returns: False
def one_even(first_number, second_number):
    if first_number % 2 == 0 or second_number % 2 == 0:
        return True
    else:
        return False
